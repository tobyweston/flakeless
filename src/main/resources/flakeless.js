					...
					_0: A2(
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(_p3.bys)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(_p3.in_)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
...
var _user$project$Main$renderDataPoint = function (dataPoint) {
	var color = function () {
		var _p4 = dataPoint.context;
		if (_p4.ctor === 'Nothing') {
			return 'grey';
		} else {
			var _p5 = _p4._0.success;
			if (_p5.ctor === 'Nothing') {
				return '#cccc00';
			} else {
				return _p5._0 ? '#00cc00' : '#cc0000';
			}
		}
	}();
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(dataPoint.when),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		while (true) {
			var _p6 = msg;
			if (_p6.ctor === 'LoadData') {
				var model_ = _elm_lang$core$Native_Utils.update(
					model,
					{raw: _p6._0});
				var _v5 = _user$project$Main$ParseData,
					_v6 = model_;
				msg = _v5;
				model = _v6;
				continue update;
